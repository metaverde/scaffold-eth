...
//need to add capability to remove eth from the contract
...
contract YourCollectible is ERC721, Ownable {
  ...
  constructor(bytes32[] memory assetsForSale) public ERC721("Pangolin", "PGN") {
  ...
  uint256 constant startingAt = 0.1 ether;
  uint16 constant numerator = 11;
  uint16 constant denominator = 3;
      ...
      returns (uint256)
  {
      ...
      //make sure they are only minting something that is marked "forsale" hre remove this parameter
