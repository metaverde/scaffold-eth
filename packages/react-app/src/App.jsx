...
function App(props) {
  ...
  return (
    <div className="App">
      ...
      <Header style={{ textAlign:"center" }} selectedKeys={[route]} mode="horizontal" />
      {networkDisplay}
      ...
      <BrowserRouter>
        ...
        <Menu >
          ...
          <Menu.Item key="/yourcollectibles">
            <Link onClick={()=>{setRoute("/yourcollectibles")}} to="/yourcollectibles">Pangolins</Link>
          </Menu.Item>
